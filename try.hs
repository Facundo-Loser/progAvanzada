...
--mejorJug :: Estado -> Int
--mejorJug (j, k) | j == C && k >= 4 = if evalEstado (H, (k-1)) == CGano then 1 else if evalEstado (H, (k-3)) == CGano then 3 else if evalEstado (H, (k-4)) == CGano then 4 else 1
--                | j == H && k >= 4 = if evalEstado (C, (k-1)) == CPerdio then 1 else if evalEstado (C, (k-3)) == CPerdio then 3 else if evalEstado (C, (k-4)) == CPerdio then 4 else 1
